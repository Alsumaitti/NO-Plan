...
// Dev-server port: defaults to 5173 locally; Replit injects PORT.
...
// BASE_PATH: Replit proxies at "/webview/<id>", Vercel serves at "/".
// Default "/" so Vercel build works without extra env vars.
